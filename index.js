...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            + 'VERSION:3.0\n' 
            + 'FN:Ghalyh Bot\n' // full name
            + 'ORG:Creator Ghalyh Bot;\n' // the organization of the contact
            + 'TEL;type=CELL;type=VOICE;waid=6285766853909:+62 857-6685-3909\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
const config = {
    A187: 'Ghalyh Bot',
    instagram: 'https://instagram.com/ghlyhalamn',
    nomer: 'http://wa.me/6285766853909',
    aktif: '24 JAM',
...
client.on('qr', qr => {
   ...
   console.log(`[ ${time} ] QR code ready nget*t`)
})
...
client.on('message-status-update', json => {
   ...
   console.log(`[ ${time} ] => bot by ig:@ff.rizkygans1`)
})
